...
class Round:
    ...
    def get_input(self) -> Tuple[int, int]:
        valid = False
        print(f"It is {self.player.value}'s turn")
        while not valid:
            coordinates_str = input(
                "Enter row and column for placement of piece. Separate with a comma: ")
            valid, res= self.validate_input(coordinates_str)
...
class Game:
    ...
    def print_winner(self):
        print(f"The winner is {self.winner.value}")
        pass
