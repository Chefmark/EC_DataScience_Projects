...
class employee_menu:
    ...
    def create_employee():
        ...
        employee_type_input = input("Enter employee's role (employee/shiftleader/owner): ")
        is_owner_input = input("Is the employee an owner(yes/no): ").upper()
        is_shiftleader_input = input("Is the employee a shiftleader(yes/no): ").upper()
        start_date_input = input("Enter startdate (YYYY-MM-DD): ")
        active = "YES"
        new_employee = Employee(employee_code=employee_code_input.upper(), first_name=first_name_input, last_name=last_name_input, emp_type=employee_type_input, is_owner=is_owner_input.upper(), is_shiftleader=is_shiftleader_input.upper(), start_date=start_date_input, active=active.upper())
    ...
    def update_employee(employees: List[Employee]):
        ...
        is_owner_update = input("Is the employee an owner(yes/no. Leave blank if there is no update): ").upper()
        is_shiftleader_update = input("Is the employee a shiftleader(yes/no. Leave blank if there is no update): ").upper()
